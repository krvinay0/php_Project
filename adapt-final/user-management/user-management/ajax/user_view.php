<?php
     ...
     */
    $aColumns  = array('id', 'name', 'avatar', 'username', 'email', 'address', 'created_at', 'status', 'id');
    $asColumns = array('id', 'name', 'avatar', 'username', 'email', 'address', 'created_at', 'status', 'id');
    $aaColumns = array('id', 'name', 'avatar', 'username', 'email', 'address', 'created_at', 'status', 'id');
