<?php
// include header file
include('..\user\header0.php');
?>
<!-- container body -->
<div class="container mx-auto p-3">
	
	<div class="container  p-3 bg-danger " style="width: 500px; color: #FFF;">
		<!-- from -->
		<form action="handel_signup.php"  method="post" autocomplete="off" onsubmit="return validateForm()">
			<!-- header of form -->
			...
			<div class="form-group" align="center">
				<input type="submit" class="form-group btn" name="submit" value="Submit">
			</div>
			
			<!-- redirect to login page message print -->
			<div class="text-center">
				<label>You have already account?<a href="index.php">Login</a></label>
			</div>
		</form>
	</div>
</div>
